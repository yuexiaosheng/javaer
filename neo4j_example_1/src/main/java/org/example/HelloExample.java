...
public class HelloExample
{
    ...
    public HelloExample(String uri, String user, String password)
    {
    ...
    {
        HelloExample example = new HelloExample("bolt://localhost:7687", "neo4j", "123456");
        example.addPerson("Ada");
        example.addPerson("Alice");
        example.addPerson("Bob");
        example.printPeople("A");
        example.close();
        //在http://localhost:7474/browser/ 里输入 MATCH (a:Person) return a
    }
}